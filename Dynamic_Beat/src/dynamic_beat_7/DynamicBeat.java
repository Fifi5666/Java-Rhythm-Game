...
//	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/beethoven.jpg")).getImage();
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("DOTSPFTitle.png", "ballet1.jpg", "ice2.jpg", "설탕요정.mp3", "DanceOfTheSugarPlumFairies.mp3"));
		trackList.add(new Track("beethovenTitle.png", "beethoven.jpg", "piano.jpg", "SymphonyNo5.mp3", "SymphonyNo5.mp3"));
		...
		startButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {	// 클릭
				Music buttonEnteredMusic = new Music("buttonPressedMusic.mp3", false);
				buttonEnteredMusic.start();
				// 게임 시작화면으로 넘어가면 인트로 뮤직 종료
				introMusic.close();
				// 시작은 0으로
				selectTrack(0);
//				Music selectedMusic = new Music("DanceOfTheSugarPlumFairies.mp3", true);
//				selectedMusic.start();
				// 게임 시작 이벤트
